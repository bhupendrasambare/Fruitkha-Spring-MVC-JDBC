...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
    	List<feedback> feed = (List<feedback>) request.getAttribute("allFeedback");
    %>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Feedback  &ensp;<div id="dowload" class="btn btn-info btn-rounded btn-sm"> Download</div></h4>
